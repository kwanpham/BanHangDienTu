...
{
    editedField = field; CKFinder.Popup(CKFinderpath + '/GIS/scripts/ckfinder/ckfinder.html?type=' + str_type, null, null, SetFileField);// /GIS/
}

function BrowseServer2( field, str_type)
{
    editedField = field; CKFinder.Popup(CKFinderpath + '/GIS/scripts/ckfinder/ckfinder.html?type=' + str_type, null, null, SetFileField);
}
